	 	      ...
	 	      //  qText.setText("Click on the material from hard to soft ");
	 	       ...
	 	       // qText.setBackgroundResource(R.color.highlightedTextViewColor);
	 	    	...
	 	    	//tv.setText("RAM");
	 	         ...
	 	         image = (TextView) findViewById(R.id.textViewMC1);
	 	         image.setOnClickListener( this);
	 	         image1 = (TextView) findViewById(R.id.textViewMxLI);
	 	         image1.setOnClickListener(this);
	 			//image1.setImageBitmap(null);
	 			
	 	         image2 = (TextView) findViewById(R.id.textViewMLI1);
				 ...
				 Timer RunSplash = new Timer();
					...
					TimerTask ShowSplash = new TimerTask() {
						...
						public void run() {
							...
							Intent myIntent = new Intent(six.this,
									MainActivity.class);
